...
out/kernel8.img: out out/boot.o out/main.o out/uart.o out/mbox.o
	ld.lld -m aarch64elf out/boot.o out/main.o out/uart.o out/mbox.o -T link.ld -o out/kernel8.elf
...
-include out/main.d out/uart.d out/mbox.d
